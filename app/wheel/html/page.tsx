...
import WheelHtml from '@/components/WheelHtml';
...
function EntryList({ entries }: { entries: WheelEntry[] }) {
    return (
        <>
            <WheelHtml entries={entries} isClub={isClub}/>
            <p className="max-w-200">This page relies on an experimental new API called HTML-In-Canvas. Currently it is only available in Chrome and must be enabled here: <a className="block" href="chrome://flags/#canvas-draw-element">chrome://flags/#canvas-draw-element</a></p>
